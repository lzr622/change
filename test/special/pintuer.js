$(function() {
    ...
    $(".banner").each(function() {
        ...
        if (pointer != 0 && page > 1) {
            ...
            var lefter = $('<div class="pager-prev"><img src="./Indonesian/left_arrow.png" alt="" class="img-responsive"></div>');
            var righter = $('<div class="pager-next"><img src="./Indonesian/right_arrow.png" alt="" class="img-responsive"></div>');
            if (style != null) {
